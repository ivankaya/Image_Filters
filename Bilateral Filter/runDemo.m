...
%img1 = double(imread('images/einstein.jpg'))/255;
%img2 = double(imread('images/mandrill.jpg'))/255;
img1 = double(imread('images/academy.jpg'))/255;
...
imshowpair(img1, bflt_img1, 'montage');
